...
import Button from '@material-ui/core/Button';
 ...
 const Tables = () => (
   <div className={styles.component}>
     ...
     <Button variant="text" component={Link} to={`${process.env.PUBLIC_URL}/tables/booking/123abc`} >Booked table 123abc</Button>
     <Button variant="text" component={Link} to={`${process.env.PUBLIC_URL}/tables/event/new`} >New booking event</Button>
     <Button variant="text" component={Link} to={`${process.env.PUBLIC_URL}/tables/event/456def`} >Booked event 456def</Button>
